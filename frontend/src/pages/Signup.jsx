...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        const response = await fetch("http://localhost:3000/api/user/create-account", {
            method: "PUT",
            headers: {
            ...
            <div className="bg-hvs-yellow p-6 rounded shadow-md w-80">
                ...
                <form className="flex flex-col items-start gap-2" onSubmit={handleLogin}>
                    ...
                    <div className="flex justify-between w-full">
                        <button className="hvs_btn" type="button" onClick={() => navigate('/login')}>
                            <p className="hvs-text">Return</p>
                        </button>
